        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-3">
              {[
                { label: t("recipe.protein"), value: recipe.nutrition.protein, color: "bg-blue-100 text-blue-700" },
                { label: t("recipe.carbs"), value: recipe.nutrition.carbs, color: "bg-amber-100 text-amber-700" },
                { label: t("recipe.fat"), value: recipe.nutrition.fat, color: "bg-rose-100 text-rose-700" },
                { label: t("recipe.fiber"), value: recipe.nutrition.fiber, color: "bg-green-100 text-green-700" },
              ].map((n) => (
          ...
          <div>
            <h2 className="text-sm font-semibold text-stone-500 uppercase tracking-wide mb-3">
              {t("recipe.instructionsTitle", { count: recipe.steps.length })}
            </h2>
